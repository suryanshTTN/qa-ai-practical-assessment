...
- Name: ui\e2e-purchase.spec.js >> Regression @regression >> TC-UI-04 profile shows the name/email used at registration @regression
- Location: tests\ui\e2e-purchase.spec.js:48:3
