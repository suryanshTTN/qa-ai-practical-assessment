...
- Name: PrismStructure\tests\api\auth-cart-invoice.spec.js >> API Regression @regression >> TC-API-05 duplicate registration email is rejected @regression
- Location: PrismStructure\tests\api\auth-cart-invoice.spec.js:82:3
