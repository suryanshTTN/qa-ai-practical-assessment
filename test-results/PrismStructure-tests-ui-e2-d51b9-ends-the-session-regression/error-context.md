...
- Name: PrismStructure\tests\ui\e2e-purchase.spec.js >> Regression @regression >> TC-UI-05 logout ends the session @regression
- Location: PrismStructure\tests\ui\e2e-purchase.spec.js:66:3
