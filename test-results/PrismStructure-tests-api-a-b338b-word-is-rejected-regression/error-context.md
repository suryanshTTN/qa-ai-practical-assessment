...
- Name: PrismStructure\tests\api\auth-cart-invoice.spec.js >> API Regression @regression >> TC-API-04 login with wrong password is rejected @regression
- Location: PrismStructure\tests\api\auth-cart-invoice.spec.js:74:3
