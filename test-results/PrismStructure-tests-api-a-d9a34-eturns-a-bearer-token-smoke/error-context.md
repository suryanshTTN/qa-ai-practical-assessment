...
- Name: PrismStructure\tests\api\auth-cart-invoice.spec.js >> API Smoke @smoke >> TC-API-01 register then login returns a bearer token @smoke
- Location: PrismStructure\tests\api\auth-cart-invoice.spec.js:9:3
